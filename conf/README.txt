...
Files without an extension will be parsed as YAML.
For clarity, extension-less files should be avoided.

Files in this directory override or extend the default configuration
defined in group_vars/all, enabling overrides of site-specific
